...
/////////////////////////////////////////// seed
#include <seed/seedstate.h>
#include <seed/seedDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <seed/storageresults.h>
///////////////////////////////////////////

extern std::unique_ptr<SeedState> globalState;
...
using ExtractSeedTX = std::pair<std::vector<SeedTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
#define WORKING_VERSION "/Seedcore:5.3.0/"
#endif

static const int64_t DARKSEND_COLLATERAL = (42000*COIN); //42000 SEED
static const int64_t DARKSEND_FEE = (0.002*COIN); // reward masternode
static const int64_t DARKSEND_POOL_MAX = (1999999.99*COIN);

static const int nSeedProtocolSwitchHeight = 580000;
...
extern unsigned int dgpMaxBlockSize; // seed
...
class SeedTxConverter{

public:

    SeedTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransaction>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionSeedTransactions(ExtractSeedTX& seedTx);
...
private:
    ...
    SeedTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<SeedTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
...
private:
    ...
    std::vector<SeedTransaction> txs;
