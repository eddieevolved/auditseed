...
////////////////////////////////////////////////////////////// // seed
	void setSeedSchedule(EVMSchedule _seedSchedule) const { seedSchedule = _seedSchedule; }

	EVMSchedule& getSeedSchedule() const { return seedSchedule; }
...
private:
	...
	mutable EVMSchedule seedSchedule; // seed
