...
#include "genesis/seedMainNetwork.cpp"
#include "genesis/seedTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::seedMainNetwork: return c_genesisInfoSeedMainNetwork;
	case Network::seedTestNetwork: return c_genesisInfoSeedTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::seedMainNetwork: return c_genesisStateRootSeedMainNetwork;
	case Network::seedTestNetwork: return c_genesisStateRootSeedTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
