...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Seed features */
        {"seed", "masternode", &masternode, true, true, false},
        //{"seed", "masternodelist", &masternodelist, true, true, false},
        //{"seed", "mnbudget", &mnbudget, true, true, false},
        //{"seed", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"seed", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"seed", "mnsync", &mnsync, true, true, false},
        {"seed", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"seed", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> seed-cli " + methodname + " " + args + "\n";
}
