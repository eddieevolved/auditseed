...
UpdateInfoDialog::DialogResult UpdateInfoDialog::showUpdateInfo(QList<SeedUpdater::SeedUpdateInfo> updates, bool &runAsAdmin, bool editable, bool detailed, QWidget *parent)
{
	if(!detailed) {
...
void QtSeedUpdater::UpdateInfoDialog::on_acceptButton_clicked()
{
...
void QtSeedUpdater::UpdateInfoDialog::on_delayButton_clicked()
{
