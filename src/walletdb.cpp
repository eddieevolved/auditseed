...
bool CWalletDB::WriteSeedNodeConfig(std::string sAlias, const CSeedNodeConfig& nodeConfig)
{
    nWalletDBUpdateCounter++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadSeedNodeConfig(std::string sAlias, CSeedNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseSeedNodeConfig(std::string sAlias)
{
    nWalletDBUpdateCounter++;
