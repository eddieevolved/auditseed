...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Seedcore seed-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  seed-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded seed transaction") + "\n" +
                               "  seed-tx [options] -create [commands]   " + _("Create hex-encoded seed transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded seed transaction
