...
static Checkpoints::MapCheckpoints mapCheckpoints =
        boost::assign::map_list_of
                ( 0,   uint256("0x00000a525b65dc3b457a18fa8f3d4276e806937a2ebee6f96bec6808f09090e5") )
;

static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1550065503, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        consensus.powLimit = ~uint256(0) >> 20; // SEED starting difficulty is 1 / 2^12
        consensus.nPowTargetTimespan = 30 * 60; //36 * 60 * 60; // SEED: 1 36hrs
        consensus.nPowTargetSpacing = 2 * 60;  // SEED: 2 minute
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1550065503; // 01/07/2018
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1581292800; // 01/07/2019

        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1550065503; // 01/07/2018
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1581292800; // 01/07/2019
        ...
        nSwitchPhi2Block = 0;
        nFirstSCBlock = 50000;
        nPruneAfterHeight = 201;
        nSplitRewardBlock = 201;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1550065503; //10/10/2017
        genesis.nBits = 0x1e0fffff;
        genesis.nNonce = 109943;
        ...
        assert(consensus.hashGenesisBlock == uint256("0x00000a525b65dc3b457a18fa8f3d4276e806937a2ebee6f96bec6808f09090e5"));
        assert(genesis.hashMerkleRoot == uint256("0x3c3c7ea609d2b95d48ccbc3b0552c16cdf0efd89d5fc68bffe742e63c21c8a86"));

        ////////////////////////////////////////////////////////////////////////////////////////////////
        vSeeds.push_back(CDNSSeedData("188.166.93.135", "188.166.93.135"));
        vSeeds.push_back(CDNSSeedData("188.166.125.98", "188.166.125.98"));
        vSeeds.push_back(CDNSSeedData("178.62.199.37", "178.62.199.37"));
        vSeeds.push_back(CDNSSeedData("174.138.0.169", "174.138.0.169"));
        ////////////////////////////////////////////////////////////////////////////////////////////////

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,63); // SEED address start with 'L'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,125); // SEED script addresses start with 'S'
        ...
        nStartMasternodePayments = 1550065503; // 10/10/2017
...
public:
    CTestNetParams()
    {
        ...
        //consensus.BIP34Height = 227931;
        //consensus.BIP34Hash = uint256S("0x000000000000024b89b42a942fe0d9fea3bb44ab7bd1b19115dd6a759c0808b8");
        consensus.powLimit = ~uint256(0) >> 10; // SEED starting difficulty is 1 / 2^12
        consensus.nPowTargetTimespan = 30 * 60; //36 * 60 * 60; // SEED: 1 36hrs
        consensus.nPowTargetSpacing = 2 * 60;  // SEED: 2 minute
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
...
//        std::cout << genesis.hashMerkleRoot.GetHex() << std::endl;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 48); // Testnet seed addresses start with 'l'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 63);  // Testnet seed script addresses start with 'S'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 155);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet seed BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet seed BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet seed BIP44 coin type is '1' (All coin's testnet default)
        // SEED BIP44 coin type is '1'
        nExtCoinType = 1;
        bech32_hrp = "tb";
...
public:
    CRegTestParams()
    {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Seed: 1 day
        consensus.nPowTargetSpacing = 1 * 60; // Seed: 1 minutes
...
public:
    CSegWitTestnet()
    {
        ...
        consensus.nPowTargetSpacing = 60;  // SEED: 1 minute
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,48); // SEED Start letter L
