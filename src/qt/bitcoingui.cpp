...

{
    ...
    resize(1200, 750);
    QString windowTitle = tr("Seedcore") + " - ";

#ifdef ENABLE_UPDATER
    controller = new QtSeedUpdater::UpdateController(QStringLiteral("v5.3.0"), this);
    ...
    //fill in frameSocMedia
    {
        ...
        connect(pushButtonTelegram, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://t.me/SEEDcoreOfficial"));});
        ...
        connect(pushButtonTwitter, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://twitter.com/SEED_Coin"));});
        ...
        connect(pushButtonGithub, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://github.com/seed-core"));});
        ...
        connect(pushButtonHelp, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://docs.seedcore.io/"));});
    ...
    {
        QString url = "https://github.com/SEED-Core/seed/releases";
        QString link = QString("<a href=\\\"\"+ url +\"\\\">\"+ url +\"</a>").arg(NEW_RELEASES, NEW_RELEASES);
        QString message(tr("New seed-qt version available: <br /> %1. <br />").arg(link));
...
void BitcoinGUI::createActions() {
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SEED address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and seed: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/seedcoin_black"), tr("&About Seedcore"), this);
    aboutAction->setStatusTip(tr("Show information about Seedcore"));
    aboutAction->setMenuRole(QAction::AboutRole);

#ifdef ENABLE_UPDATER
    // Check for update menu item
    checkForUpdateAction = new QAction(QIcon(":/icons/update_black"), tr("Check for &Update"), this);
    checkForUpdateAction->setStatusTip(tr("Check whether there is an updated wallet from Seedcore"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SEED"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/seedcoin_black"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SEED addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verified"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SEED addresses"));
    ...
    openAction->setStatusTip(tr("Open a SEED: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    openHexAddressAction = new QAction(QIcon(":/icons/editcopy"), tr("&Hex Address Converter"), this);
    openHexAddressAction->setStatusTip(tr("Converter for SEED Smart Contract addresses"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Seedcore help message to get a list with possible SEED command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle) {
    ...
    QString toolTip = tr("Seedcore client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updaterClicked() {
    if (!clientModel)
        return;
#ifdef ENABLE_UPDATER
    controller->start(QtSeedUpdater::UpdateController::ProgressLevel);
#else
...
void BitcoinGUI::updateNetworkState() {
    ...
    if (clientModel->getNetworkActive())
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Seedcore network", "", count));
    else
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret) {
    QString strTitle = tr("Seedcore"); // default title
