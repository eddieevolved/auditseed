...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Seedcore RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  seed-cli [options] <command> [params]  " + _("Send command to Seedcore") + "\n" +
                        "  seed-cli [options] help                " + _("List commands") + "\n" +
                        "  seed-cli [options] help <command>      " + _("Get help for a command") + "\n";
