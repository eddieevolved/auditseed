...
public:
    ...
    bool WriteSeedNodeConfig(std::string sAlias, const CSeedNodeConfig& nodeConfig);
    bool ReadSeedNodeConfig(std::string sAlias, CSeedNodeConfig& nodeConfig);
    bool EraseSeedNodeConfig(std::string sAlias);
