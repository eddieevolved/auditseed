...
This means one can have an always-on seedd instance running, and another local seedd/seed-qt instance which connects to this node and receives blocks from it.
