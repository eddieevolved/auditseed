...
from test_framework.test_framework import SeedTestFramework, SkipTest
...
class ZMQTest (SeedTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that seed has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("seedd has not been built with zmq enabled.")
