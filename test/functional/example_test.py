...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SeedTestFramework
    pass

class ExampleTest(SeedTestFramework):
    # Each functional test is a subclass of the SeedTestFramework class.
    ...
    def custom_method(self):
        ...
        SeedTestFramework class so other tests can use it."""
