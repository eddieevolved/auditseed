#!/bin/sh
#-###############################################-#
# C++ Cross-Compiler - The Seedcore Developer-2018 #
#-###############################################-#
...
[ -f "./src/qt/seed-qt.exe" ] && cp "./src/qt/seed-qt.exe" "$RELEASE"
[ -f "./src/seedd.exe" ] && cp "./src/seedd.exe" "$RELEASE"
[ -f "./src/seed-cli.exe" ] && cp "./src/seed-cli.exe" "$RELEASE"
