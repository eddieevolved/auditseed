...
In order to support loading of multiple wallets in seed-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is seed.cpp.
...
Changes to seed.cpp
----------------------
seed.cpp is the entry point into seed-qt, and as such, will require some minor modifications to provide hooks for
