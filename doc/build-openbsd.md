...
This guide describes how to build seedd and command-line utilities on OpenBSD.
...
git clone https://github.com/SEED-Core/seed.git
```
...
(see issue [#6658](https://github.com/SEED-Core/seed/issues/)).
