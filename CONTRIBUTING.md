Contributing to Seedcore
============================

The Seedcore project operates an open contributor model where anyone is
...
The following applies to code changes to the Seedcore project, and is not to be
confused with overall SEED Network Protocol consensus changes.

Whether a pull request is merged into Seedcore rests with the project merge
...
Patches that change SEED consensus rules are considerably more involved than
...
Where a patch set proposes to change the SEED consensus, it must have been
...
The project leader is the release manager for each Seedcore release.
